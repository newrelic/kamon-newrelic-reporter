# Contributing to New Relic Kamon Exporter
Thanks for your interest in contributing to the New Relic Kamon Exporter! We look forward to engaging with you.
...
We'd love to get your contributions to improve the Kamon Exporter! Keep in mind when you submit your pull request, you'll need to sign the CLA via the click-through using CLA-Assistant. You only have to sign the CLA one time per project.
...
If you can build the Exporter, you can develop it!
...
## License
By contributing to the New Relic Kamon Expoter, you agree that your contributions will be licensed under the [License file](LICENSE) 
