...
Generate an artifact at `kamon-newrelic/target/scala-2.13/kamon-newrelic_2.13-0.0.1-SNAPSHOT.jar`
...
libraryDependencies ++= Seq(
    ...
    "com.newrelic.telemetry" %% "kamon-newrelic-reporter" % "0.0.1-SNAPSHOT",
    ...
)
```
